// Source: https://github.com/lwouis/macos-traffic-light-buttons-as-SVG
// Author: lwouis
// License: CC0 1.0
...
export const MaximizeNormalSVG = () => (
  ...
  >
    <g clip-rule="evenodd" fill-rule="evenodd">
      ...
      <path d="m42.7 81.8c21.6 0 39.1-17.5 39.1-39.1s-17.5-39.1-39.1-39.1-39.1 17.5-39.1 39.1 17.5 39.1 39.1 39.1z" fill="#61c555"/>
    </g>
  </svg>
);
